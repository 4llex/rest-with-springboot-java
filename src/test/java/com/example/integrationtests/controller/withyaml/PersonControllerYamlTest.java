...
public class PersonControllerYamlTest extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws IOException {
		...
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/persons/v1/761\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/persons/v1/396\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/persons/v1/550\""));

		assertTrue(content.contains("rel: \"first\"  href: \"http://localhost:8888/api/persons/v1?direction=asc&page=0&size=10&sort=firstName,asc\""));
		//assertTrue(content.contains("rel: \"prev\"  href: \"http://localhost:8888/api/persons/v1?direction=asc&page=2&size=10&sort=firstName,asc\""));
		assertTrue(content.contains("rel: \"self\"  href: \"http://localhost:8888/api/persons/v1?page=0&size=10&direction=asc\""));
		assertTrue(content.contains("rel: \"next\"  href: \"http://localhost:8888/api/persons/v1?direction=asc&page=1&size=10&sort=firstName,asc\""));
		assertTrue(content.contains("rel: \"last\"  href: \"http://localhost:8888/api/persons/v1?direction=asc&page=100&size=10&sort=firstName,asc\""));

		assertTrue(content.contains("page:  size: 10  totalElements: 1006  totalPages: 101  number: 0"));
	}
